      ...
      <div class="box box-primary">
         <div class="box-header with-border">
            ...
            <div class="box-tools pull-right">
               <a href="<?= base_url(); ?>konsultasi/inbox" class="btn btn-social btn-default btn-flat btn-sm">
         ...
         <div class="box-footer">
            <a href="<?= base_url(); ?>konsultasi/reply/<?= $this->secure->encrypt_url($read['id_konsultasi']); ?>" class="btn btn-social btn-primary btn-flat btn-sm">
