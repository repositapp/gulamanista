<div class="row">
      ...
      <div class="box box-solid">
         ...
         <div class="box-body no-padding">
            <ul class="nav nav-pills nav-stacked">
               <li class="active"><a href="<?= base_url(); ?>konsultasi/inbox"><i class="fa fa-inbox"></i> Kontak Masuk</a></li>
   ...
   <div class="col-md-9">
      <div class="box box-primary">
         <div class="box-header with-border">
            <h3 class="box-title">Kontak Masuk</h3>
         </div>
         <div class="box-body">
            <table class="table datatable table-bordered table-striped">
               ...
               <tbody>
                  ...
                  foreach ($data_inbox->result_array() as $inbox) :
                     $petugas = $this->db->get_where('user', ['id_user' => $inbox['pengirim']])->row_array();
                  ?>
                     <tr>
                        <td>
                           <button type="button" class="btn btn-success btn-sm btn-flat view_umkm" data-id="<?= $inbox['id_konsultasi']; ?>">
                              <i class="fa fa-eye"></i>
                           </button>
                        </td>
                        <td class="text-center"><?= $no; ?>.</td>
                        <td><?= $inbox['title_klinik']; ?></td>
